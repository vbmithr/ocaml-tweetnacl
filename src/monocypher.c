...
CAMLprim value ml_randombytes(value x, value xlen) {
    getrandom(Caml_ba_data_val(x), Long_val(xlen), 0);
    return Val_unit;
}

CAMLprim value ml_crypto_lock(value mac, value c, value k, value n, value m) {
...
CAMLprim value ml_crypto_unlock(value m, value k, value n, value mac, value c) {
    return Val_int(crypto_unlock(Caml_ba_data_val(m),
                                 Caml_ba_data_val(k),
                                 Caml_ba_data_val(n),
